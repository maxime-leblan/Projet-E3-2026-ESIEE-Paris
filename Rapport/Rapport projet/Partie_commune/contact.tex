...
\begin{figure}[!ht]
\centering 
\includegraphics[width=0.5\columnwidth]{chantier1.png} 
\caption[Projet d'origine]{Projet d'origine}
\end{figure}
...
\begin{figure}[!ht]
\centering 
\includegraphics[width=0.5\columnwidth]{chantier2.png} 
\caption[Prévention sécurité GTM Ouest]{Prévention sécurité GTM Ouest}
\end{figure}
...
\begin{figure}[!ht]
\centering 
\includegraphics[width=0.5\columnwidth]{Chantier4.jpg}
\caption[Visite du chantier du métro à Nanterre la Folie]{Visite du chantier du métro à Nanterre la Folie}
\end{figure}

\begin{figure}[!ht]
\centering 
\includegraphics[width=0.5\columnwidth]{Chantier6.jpg} 
\caption[Pelleteuse avec système de sécurité laser]{Pelleteuse avec système de sécurité laser}
\end{figure}

\begin{figure}[!ht]
\centering 
\includegraphics[width=0.5\columnwidth]{Chantier7.jpg} 
\caption[Exemple de pelleteuse pouvant être équipé de notre dispositif]{Exemple de pelleteuse pouvant être équipé de notre dispositif}
\end{figure}