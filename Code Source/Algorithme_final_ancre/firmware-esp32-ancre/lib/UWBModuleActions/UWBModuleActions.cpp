...
void initUWBModule(int pAnchorId)
{
    ...
    sendATCommand("AT+SETPAN=" + String(NETWORK_ID), Serial, UWBSerial); // Rejoindre le réseau commun
    sendATCommand("AT+SETRPT=1", Serial, UWBSerial); // Désactiver les rapports de distance à chaque mesure  
