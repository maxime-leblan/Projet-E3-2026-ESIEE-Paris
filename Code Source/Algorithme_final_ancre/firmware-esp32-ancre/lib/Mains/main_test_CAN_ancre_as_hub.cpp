...
void loop() {
    ...
    Serial.println("On essaie de lire un message du hub par CAN");
    ...
    if (receiveCanMessage(vCanMessage))
    {
        ...
        {
            Serial.println("Message reçu du hub " + String(vDecodedCanData.id_ancre) + ", tag " + String(vDecodedCanData.id_tag));
